<template>
  <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div>
                <h2 class="text-2xl font-semibold leading-tight">Farmonlar</h2>
            </div>
            ...
            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div class="border border-gray-300 inline-block min-w-full overflow-hidden rounded-lg shadow shadow-md">
